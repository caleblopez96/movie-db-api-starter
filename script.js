...
function getPopularMovies() {
    // the endpoint
    let url = `https://api.themoviedb.org/3/movie/popular?api_key=502fe1fd9a6855cc46b5147c5e7a4629&language=en-US&page=1`;
    let endpoint;
...
function getBirthYearMovies(e) {
    ...
    if (year < 1940 || year > 2024 || year == "") {
        ...
        let baseUrl =
            "https://api.themoviedb.org/3/discover/movie?api_key=502fe1fd9a6855cc46b5147c5e7a4629&include_adult=false&include_video=false&language=en-US&page=1&primary_release_year=";
        ...
        // open the request
        xhr.open("GET", `${baseUrl}${year}${endUrl}`);
